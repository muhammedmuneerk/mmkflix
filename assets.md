...
API_KEY = "bc76f916396c5dfa103f3c5fe33cfa7f"



////////////////  things that can add into the project more  ///////////////////////////////
login
options on header
2 buttons on banner - Play,My List
search - for movies or genres
being able to make list of favorite movies , putting it on favorite list or page